...
string print_guest_list( const std::string[], size_t);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
...
void clear_guest_list(std::string guest_list[], size_t size) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THEPARENTHESES

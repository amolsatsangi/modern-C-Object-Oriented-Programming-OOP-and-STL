...
double a_penny_doubled_everyday(int n, double penny) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
    function_activation_count++;
    //----DO NOT MODIFY THE CODE ABOVE THIS LINE----
    //----WRITE THE FUNCTION BODY BELOW THIS LINE----
    if(n == 1)
        return 1*penny;
    return 2*a_penny_doubled_everyday(n-1,penny);
